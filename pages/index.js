...
.card-tl{display:flex;flex-direction:column;align-items:center;align-self:flex-start;line-height:1;gap:3px;padding:5px 0 0 5px}
.card-br{display:flex;flex-direction:column;align-items:center;align-self:flex-end;line-height:1;gap:3px;padding:0 5px 5px 0}
