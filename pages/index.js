...
/* HEADER */
.hdr{display:flex;align-items:center;justify-content:space-between;padding:6px 14px 5px;flex-shrink:0;border-bottom:1px solid var(--border);background:var(--surface)}
...
/* CARD GRID */
.card-grid{display:grid;grid-template-columns:1fr 1fr;gap:5px;padding:5px 10px;flex-shrink:0}
...
.card-tl{display:flex;flex-direction:column;align-items:center;align-self:flex-start;width:fit-content;line-height:1;gap:3px;padding:5px 0 0 5px}
.card-br{display:flex;flex-direction:column;align-items:center;align-self:flex-end;width:fit-content;line-height:1;gap:3px;padding:0 5px 5px 0}
...
/* SOLS STRIP */
.sols-strip{padding:1px 10px 0;display:flex;gap:5px;overflow-x:auto;flex-shrink:0;scrollbar-width:none;height:20px;align-items:center}
...
.feedback{font-family:'DM Mono',monospace;font-size:10px;padding:1px 10px;height:16px;letter-spacing:.5px;transition:color .15s}
